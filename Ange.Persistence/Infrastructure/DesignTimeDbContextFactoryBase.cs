namespace Ange.Persistence.Infrastructure
{
    ...
    {
        private const string ConnectionStringName = "AngeDatabase";
        private const string AspNetCoreEnvironment = "ASPNETCORE_ENVIRONMENT";

        public TContext CreateDbContext(string[] args)
        {
            var basePath = Directory.GetCurrentDirectory() +
                           string.Format("{0}..{0}Ange.WebUI", Path.DirectorySeparatorChar);
